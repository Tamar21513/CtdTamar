...
CPP_FILES = [
    os.path.join("server", "chess_server", "tests", "legacy_console_main.cpp"),
    os.path.join("server", "chess_server", "src", "App", "ConsoleApp.cpp"),
    os.path.join("shared", "cpp", "src", "Core", "Position.cpp"),
    os.path.join("shared", "cpp", "src", "Core", "Piece.cpp"),
    os.path.join("shared", "cpp", "src", "Core", "Board.cpp"),
    os.path.join("server", "chess_server", "src", "IO", "BoardParser.cpp"),
    os.path.join("server", "chess_server", "src", "IO", "BoardPrinter.cpp"),
    os.path.join("server", "chess_server", "src", "IO", "BoardMapper.cpp"),
    os.path.join("server", "chess_server", "src", "Rules", "PieceRules.cpp"),
    os.path.join("server", "chess_server", "src", "Rules", "RuleEngine.cpp"),
    os.path.join("server", "chess_server", "src", "Engine", "GameEngine.cpp"),
    os.path.join("server", "chess_server", "src", "Control", "Controller.cpp"),
    os.path.join("server", "chess_server", "src", "Realtime", "RealTimeArbiter.cpp"),
    os.path.join("server", "chess_server", "src", "Messaging", "EventBus.cpp"),
    os.path.join("server", "chess_server", "src", "Messaging", "GameEventSubscribers.cpp"),
    os.path.join("server", "chess_server", "src", "Messaging", "MessageBus.cpp"),
    os.path.join("server", "chess_server", "src", "Messaging", "EngineMessageHandler.cpp"),
    os.path.join("server", "chess_server", "src", "Messaging", "GameStateSnapshotBuilder.cpp"),
]
